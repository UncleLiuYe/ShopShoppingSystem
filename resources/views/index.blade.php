...
<body>
    <div class="container">
        ...
        <div class="container" style="margin-top: 77px;">
            <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    @if($loop->index < 4) <div class="carousel-item {{$loop->index == 0 ? 'active' : ''}}">
        ...
        <div class="row">
            @foreach($productlist as $product)
            @if($loop->index<4) <div class="col-3" style="margin-bottom: 30px;">
                <div class="card" onclick="window.location.href='{{route('product.show',[$product->id])}}'">
                    <img src="/storage/images/{{$product->cover}}" class="card-img-top" alt="" width="200px" height="200px">
